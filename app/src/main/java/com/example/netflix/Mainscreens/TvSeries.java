...
import com.example.netflix.Adapters.TvSeriesGridLayoutAdapter;
...
public class TvSeries extends AppCompatActivity {
    ...
    TvSeriesGridLayoutAdapter movieGridLayoutAdapter;
    int api_page_number = 1;

    String api_path="https://api.themoviedb.org/3/tv/popular?api_key=12247654257fe450ccbd7df2985ce877&language=en-US&page=1";
    ShimmerFrameLayout shimmerFrameLayout;
    ScrollView scrollView;
    ArrayList<SeriesModel> movieModels;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!checkNetworkConfig.isPrepared()){
            ...
            movieModels = new ArrayList<SeriesModel>();
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for(int i=0;i<movies.length();i++){
                    ...
                    Gson gson = new Gson();
                    movieModel = gson.fromJson(movie.toString(),SeriesModel.class);
    ...
    public void upDateRecyclerView(ArrayList<SeriesModel> list){
        shimmerFrameLayout.stopShimmer();
        shimmerFrameLayout.setVisibility(View.GONE);
        scrollView.setVisibility(View.VISIBLE);

        movieGridLayoutAdapter = new TvSeriesGridLayoutAdapter(getApplicationContext(),list);
        movies_list.setLayoutManager(new GridLayoutManager(getApplicationContext(),2));
        movies_list.setAdapter(movieGridLayoutAdapter);
    }
    public void loadUpDateRecyclerView(ArrayList<SeriesModel>list){
        movieGridLayoutAdapter.notifyDataSetChanged();
    }
